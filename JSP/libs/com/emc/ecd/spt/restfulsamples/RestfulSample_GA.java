	...
	*/
	...
	public static void main ( String[] args  )
	{
		...
		try {
			...
			System.out.println( "\n");
			System.out.println( "Welcome to the Restful Java Class sample for InfoArchive 4 (v1.1)");
			...
			String searchCompositionsURL  = getSearchCompositionsURI ( searchesURL, "DefaultSearch" );

...
public class RestfulSampleNoGUI {
	...
	*/
	...
	public static String executeStaticQuery ( String customerID, String relativePath ) throws Exception
	{
			...
			log ( "Connecting to IA using parameters:" );
			log ( "IP= " + serverIp );
			log ( "User= " + userName );
			...
			String searchURL  = getSearchURI ( searchesURL, "Phone Calls By Date Range" );
	...
	{ 
		...
		log ( "Looking for PhoneCalls default search ..." + searchName);	

...
public class RestfulSample_IA4Beta_Version {
	...
	*/
	...
	public static void main ( String[] args  )
	{
		...
		try {
			...
			System.out.println( "\n");
			System.out.println( "Welcome to the Restful Java Class sample for InfoArchive 4 (v1.0)");
			Scanner scanner = new Scanner( System.in );
		    System.out.print("Type Patient ID for the Search (or just press 'enter' to search all records): ");
	...
	{ 
		...
		for (int i = 0; i < n; ++i) {
			...
			System.out.println((n1) + " Documents found");
			System.out
					.println("All the attachments from the patients have been stored in "
